...
function PSUpload-Session($Command){
    $pwd = ConvertTo-SecureString "P@ssw0rd" -AsPlainText -Force
    $creds = New-Object System.Management.Automation.PSCredential -ArgumentList "sarath",$pwd
    $Prod_SSH = New-SSHSession -ComputerName 188.165.68.225 -Credential $creds
    $output = (Invoke-SSHCommand -SSHSession $Prod_SSH -Command $Command).output
    $x = Remove-SSHSession $Prod_SSH
    return $output
}